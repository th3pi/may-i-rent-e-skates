...
<%--This is a filter page. This view only displays products with attribute cycle in database.--%>

<title>Bicycles | Rent eSkates</title>
<!-- Page Content -->
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div class="row" id="products" ng-app="cartApp">
                <c:forEach items="${cycles}" var="ctProduct">
